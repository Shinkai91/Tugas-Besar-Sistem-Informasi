    ...
    <nav class="navbar navbar-light sticky-top justify-content-between" id="navbar">
        ...
        <form class="form-inline">
            <div class="dropdown show">
                <a class="navbar-brand mr-3 " style="color:#3C4858;text-decoration:none" data-aos="fade-left"
                    data-aos-duration="3000" href="{{ route('logout') }}">{{ session()->get('nama') }}</a>
        ...
        <div class="container">
            <div class="col-lg-12 text-center">
                ...
                <p class="text-muted para-desc mx-auto mb-4" data-aos="fade-down" data-aos-duration="2000">
                    ...
                    <a class="text-primary font-weight-bold" href="#">Rental Laptop</a></span>.
                </p>
            </div>
            <div class="card-deck">
                ...
                <div class="card" data-aos="fade-left" data-aos-duration="3000">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">With the Intel® Evo™ platform, the ThinkPad X1 Carbon Gen 9 laptop
                            delivers
